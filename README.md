...
- Open the terminal in any preferred location, create a folder name `SrimadBhagwatamApplication`, and move inside with the following command.
```
mkdir SrimadBhagwatamApplication
```
```
cd SrimadBhagwatamApplication
```
...
```
git clone https://github.com/ApurvChatur/SrimadBhagwatamApplication.git
```
...
- Kindly, check the documentation properly and ensure you are setting up the backend for `SrimadBhagwatamApplication`.

## Administration Installation
- Please ensure you have set up the backend for `SrimadBhagwatamApplication`, before setting up the admin.
...
- Kindly, check the documentation properly and ensure you are setting up the administration for `SrimadBhagwatamApplication`.