      ...
      <section className="bg-[#FCF6F5] dark:bg-[#990011] text-[#990011] dark:text-[#FCF6F5] lg:px-20">
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#990011] dark:border-[#FCF6F5] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#990011] dark:border-[#FCF6F5] leading-none">Basic Information</h1>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#990011] dark:border-[#FCF6F5] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#990011] dark:border-[#FCF6F5] leading-none">Relation Information</h1>
            ...
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#990011] dark:border-[#FCF6F5] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#990011] dark:border-[#FCF6F5] leading-none">More Information</h1>
